...
[__Nebula__](https://hex.pm/packages/nebula) is a small library for colored (ANSI) output in Erlang/Elixir. It's can be useful when you need to create a command-line application.
